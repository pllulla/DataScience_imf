...
Toma el dataset **mtcars** y, devuelve las medias de sus filas
...
Toma el dataset **mtcars** y, realiza la siguiente operación
para todas sus filas: `sqrt + 2` (solo con dos decimales)
